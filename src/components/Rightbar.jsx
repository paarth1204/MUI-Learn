    ...
    <Box flex={2} p={2} sx={{ display: { xs: "none", sm: "block" } }}>
      <Box position="fixed" width={400}>
        ...
        <AvatarGroup max={7}>
          ...
          />
          <Avatar alt="Kane" src="https://mui.com/static/images/avatar/7.jpg" />
          <Avatar alt="Kane" src="https://mui.com/static/images/avatar/8.jpg" />
          <Avatar alt="Kane" src="https://mui.com/static/images/avatar/9.jpg" />
        </AvatarGroup>
